...
<%
    ...
    if (email == null || rawPassword == null || email.isEmpty() || rawPassword.isEmpty()) {
        out.println("<div class='error-message'>Please fill in both fields.</div>");
        return;
    }
    ...
    try {
        ...
        e.printStackTrace();
        out.println("<div class='error-message'>Error hashing the password.</div>");
        return;
    }
    ...
    try {
        ...
        e.printStackTrace();
        out.println("<div class='error-message'>Database connection error.</div>");
    } finally {
